...
namespace EnvironmentCrime.Models
{
    public class IdentityInitializer
    {
        ...
        private static async Task CreateUsers(UserManager<IdentityUser> uManager)
        {
            ...
            Debug.Print("enduser");
            Debug.Print(E774.UserName);
            Debug.Print(E774.PasswordHash);
        }
        ...
        private static async Task CreateUser(IServiceProvider services)
        {
            ...
            Debug.Print("createusern1");
            IdentityUser E888 = new IdentityUser("E888");
            await uManager.CreateAsync(E888, "Pass88?");
            await uManager.AddToRoleAsync(E888, "Investigator");
            Debug.Print("createusern2");
        }
