...
namespace EnvironmentCrime.Controllers
{
    ...
    public class ManagerController : Controller
    {
        ...
        public ViewResult CrimeManager(string id)
        {
            ...
            ViewBag.ListOfEmployees = GetEmployeesForDepartment();
        ...
        public ViewResult StartManager()
        {
            ...
            {
                if (errand.DepartmentId == repository.GetCurrentEmployee().DepartmentId)
        ...
        public List<Employee> GetEmployeesForDepartment()
        {
            ...
            {
                if (employee.DepartmentId == repository.GetCurrentEmployee().DepartmentId)
